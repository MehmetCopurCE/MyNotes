            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    <?php if(isset($_SESSION['user'])): ?>
                        <!-- Kullanıcı oturumu varsa profil resmi ve menüsü -->
                        <button type="button" class="mr-3 relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                        ...
                        <button id="profileButton" type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    ...
                    <?php else: ?>
                        <!-- Kullanıcı oturumu yoksa login/register -->
                        <a href="/login" class="mr-4 rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Login</a>

                        <img class="h-8 w-8 rounded-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSooCX-nPSHN0kCVdUnm-eptCPvUF04YaxeHQ&s" alt="Default Profile">
                    <?php endif; ?>
...
<script>
    ...
    // Profil menüsü dışına tıklanıldığında menüyü kapatmak için
